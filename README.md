...
This project is a **calculator clone** that allows users to:  
...
1. User clicks number buttons to input values.  
2. Clicking operator buttons (`+`, `-`, `×`, `÷`) sets the operation.  
3. Clicking `=` calculates and displays the result.  
4. Clicking `C` clears the current input.  
